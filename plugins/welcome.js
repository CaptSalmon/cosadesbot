...
module.exports = {
  ...
  intro: function(msg) {
    return msg.send("Эй, черти. Бутылку скуумы мне и прочь отсюда. А если есть какое дело ко мне, пиши /help и я не выебу тебя в твой висящий пролапс.");
  },
  welcomeUser: function(msg, user) {
    return msg.send("Привет нвах, " + user.first_name + "!");
  }
};
