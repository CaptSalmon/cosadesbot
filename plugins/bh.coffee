...
HIKKA = ['нвах', 'флах', 'скрибово желе', 'эчлендер', 'каломник', 'скаттложор', 'корпрусник', 'мутсера']
...
bhToString = (bh) ->
    switch bh
        ...
        when 4
            icon: smiles.tengu
            text: misc.randomChoice ['Первая телваннийская!', 'Аки Дагот Ур!', 'Септимский!', 'Убить Всех Босмеров']
        else
            icon: smiles.boom
